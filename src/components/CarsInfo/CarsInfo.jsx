                        ...
                        cars.map((item, index) => (
                            <>
                                ...
                                <div className='pt-8'>
                                    <div className='flex justify-between'>
                                        <div>
                                            <span className='text-3xl text-gray-500'><CiCalendar /> </span>
                                            <p> {item.year}</p>
                                        </div>
                                        <div>
                                            <span className='text-3xl text-gray-500'>< CiAlarmOn /></span>
                                            <p> {item.seconds}</p>
                                        </div>
                                        <div>
                                            <span className='text-3xl text-gray-500'><IoMdSpeedometer /></span>
                                            <p> {item.max_speed}</p>
                                        </div>
                                        <div>
                                            <span className='text-3xl text-gray-500'><IoPersonSharp /></span>
                                            <p> {item.max_people}</p>
                                        </div>
                                    </div>
