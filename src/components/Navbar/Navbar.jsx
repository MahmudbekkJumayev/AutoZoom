      ...
      <div className="flex items-center">
        ...
        <div className="relative">
          ...
          <div
            className={`${
              isOpen ? "block" : "hidden"
            } md:hidden absolute bg-black top-[-65px] right-[-115px] px-20 py-16 z-50 h-[100vh]`}
          >
            ...
            <ul className="flex flex-col gap-4">
              <li>
                <Link
                  className="text-[27px] md:text-[30px] text-white font-medium hover:text-blue-300"
                  to="/"
                >
                  Cars
                </Link>
              ...
              <li>
                <Link
                  className="text-[27px] md:text-xl text-white font-medium hover:text-blue-300"
                  to="/"
                >
                  Brand
                </Link>
        ...
        <div className="hidden md:flex flex-col md:flex-row gap-4">
          <ul className="flex gap-4">
            <li>
              <Link
                className="md:text-[22px]  text-gray-100 font-normal hover:text-blue-300"
                to="/"
              >
                Cars
              </Link>
